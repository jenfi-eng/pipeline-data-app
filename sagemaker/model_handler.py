...
def input_fn(request_body, request_content_type):
    ...
    if request_content_type == 'application/json':
        ...
        raise ValueError(f'Request content type {request_content_type} not supported by this script.')
...
def output_fn(predictions, response_content_type):
    if response_content_type == 'application/json':
        ...
        raise ValueError(f'Response content type {response_content_type} not supported by this script.')
